...
#ifndef ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__LEFT_SHIFT_HPP
#define ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__LEFT_SHIFT_HPP

#include <utility>
#include <odds_and_ends/composite_type/operable_fwd.hpp>
#include <odds_and_ends/composite_type/event/left_shift_assignment.hpp>
...
namespace odds_and_ends { namespace composite_type {
    ...
    struct left_shift_operable
    {
        ...
        ::left_shift_operable<CompositeParentGenerator> type;
        ...
        class apply
        {
            ...
            struct _result : _composite_parent_t
            {
                ...
                {
                    this->handle(
                        ::odds_and_ends::composite_type::left_shift_assignment_event(),
                        operand
                    );
                    return this->derived();
                }
...
#endif  // ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__LEFT_SHIFT_HPP
