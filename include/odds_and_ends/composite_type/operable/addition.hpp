...
#ifndef ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__ADDITION_HPP
#define ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__ADDITION_HPP
...
namespace odds_and_ends { namespace composite_type {
    ...
    struct addition_operable
    {
        ...
        ::addition_operable<CompositeParentGenerator> type;
        ...
        class apply
        {
            ...
            struct _result : _composite_parent_t
            {
                ...
                {
                    this->handle(
                        ::odds_and_ends::composite_type::addition_assignment_event(),
                        operand
                    );
                    return this->derived();
                }
...
#endif  // ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__ADDITION_HPP
