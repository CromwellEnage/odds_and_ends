...
#ifndef ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__PRE_INCREMENT_HPP
#define ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__PRE_INCREMENT_HPP

#include <utility>
#include <odds_and_ends/composite_type/operable_fwd.hpp>
#include <odds_and_ends/composite_type/event/increment.hpp>
...
namespace odds_and_ends { namespace composite_type {
    ...
    struct pre_increment_operable
    {
        ...
        ::pre_increment_operable<CompositeParentGenerator> type;
        ...
        class apply
        {
            ...
            struct _result : _composite_parent_t
            {
                ...
                {
                    this->handle(::odds_and_ends::composite_type::increment_event());
                    return this->derived();
                }
...
#endif  // ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__PRE_INCREMENT_HPP
