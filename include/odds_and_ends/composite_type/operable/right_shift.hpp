...
#ifndef OODS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__RIGHT_SHIFT_HPP
#define OODS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__RIGHT_SHIFT_HPP
...
#include <odds_and_ends/composite_type/event/right_shift_assignment.hpp>
...
namespace odds_and_ends { namespace composite_type {
    ...
    struct right_shift_operable
    {
        ...
        ::right_shift_operable<CompositeParentGenerator> type;
        ...
        class apply
        {
            ...
            struct _result : _composite_parent_t
            {
                ...
                {
                    this->handle(
                        ::odds_and_ends::composite_type::right_shift_assignment_event(),
                        operand
                    );
                    return this->derived();
                }
...
#endif  // OODS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__RIGHT_SHIFT_HPP
