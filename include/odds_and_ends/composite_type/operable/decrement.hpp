...
#ifndef ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__DECREMENT_HPP
#define ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__DECREMENT_HPP
...
namespace odds_and_ends { namespace composite_type {
    ...
    struct decrement_operable
    {
        ...
        ::decrement_operable<CompositeParentGenerator> type;

        template <typename Derived>
        class apply
        {
            typedef typename ::boost::mpl::apply_wrap1<
                ::odds_and_ends::composite_type::pre_decrement_operable<
...
}}  // namespace boost::composite_type

#endif  // ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__DECREMENT_HPP
