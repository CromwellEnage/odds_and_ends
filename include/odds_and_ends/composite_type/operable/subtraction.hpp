...
#ifndef ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__SUBTRACTION_HPP
#define ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__SUBTRACTION_HPP
...
namespace odds_and_ends { namespace composite_type {
    ...
    struct subtraction_operable
    {
        ...
        ::subtraction_operable<CompositeParentGenerator> type;
        ...
        class apply
        {
            ...
            struct _result : _composite_parent_t
            {
                ...
                {
                    this->handle(
                        ::odds_and_ends::composite_type::subtraction_assignment_event(),
                        operand
                    );
                    return this->derived();
                }
...
#endif  // ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__SUBTRACTION_HPP
