...
#ifndef ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__BIT_XOR_HPP
#define ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__BIT_XOR_HPP
...
#include <odds_and_ends/composite_type/event/bit_xor_assignment.hpp>
...
namespace odds_and_ends { namespace composite_type {
    ...
    struct bit_xor_operable
    {
        ...
        ::bit_xor_operable<CompositeParentGenerator> type;
        ...
        class apply
        {
            ...
            struct _result : _composite_parent_t
            {
                ...
                {
                    this->handle(
                        ::odds_and_ends::composite_type::bit_xor_assignment_event(),
                        operand
                    );
                    return this->derived();
                }
...
#endif  // ODDS_AND_ENDS__COMPOSITE_TYPE__OPERABLE__BIT_XOR_HPP
