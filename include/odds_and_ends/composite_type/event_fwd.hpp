...
namespace odds_and_ends { namespace composite_type {
    ...
    struct coercive_move_constructor_event;
    struct move_assignment_event;
    struct move_2nd_stage_event;
    struct operator_event;
    struct increment_event;
    struct decrement_event;
    struct addition_assignment_event;
    struct subtraction_assignment_event;
    struct multiplication_assignment_event;
    struct division_assignment_event;
    struct modulo_assignment_event;
    struct bit_and_assignment_event;
    struct bit_or_assignment_event;
