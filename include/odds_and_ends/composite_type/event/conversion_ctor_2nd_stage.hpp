...
#ifndef ODDS_AND_ENDS__COMPOSITE_TYPE__CONVERSION_CTOR_2ND_STAGE_EVENT_HPP
#define ODDS_AND_ENDS__COMPOSITE_TYPE__CONVERSION_CTOR_2ND_STAGE_EVENT_HPP
...
namespace odds_and_ends { namespace composite_type {
    ...
    struct conversion_constructor_2nd_stage_event :
        ::odds_and_ends::composite_type::constructor_2nd_stage_event
    {
    };
}}  // namespace odds_and_ends::composite_type

#endif  // ODDS_AND_ENDS__COMPOSITE_TYPE__CONVERSION_CTOR_2ND_STAGE_EVENT_HPP
