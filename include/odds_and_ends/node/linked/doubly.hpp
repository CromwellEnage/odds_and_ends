                ...
                class apply
                {
                    typedef typename ::boost::mpl::apply_wrap1<
                        typename ::boost::mpl::apply_wrap1<
                            ::odds_and_ends::node::linked::base<XForm>,
                    ...
                    protected:
                        ...
                        ) : _composite_parent_t(e, arg_pack), _prior(nullptr)
                        {
                        }
                        ...
                        inline _result(
                            ...
                            Copy const& copy
                        ) : _composite_parent_t(e, copy), _prior(nullptr)
                        {
                        }
                        ...
                        inline _result(
                            ...
                            Copy const& copy,
                            Alloc const& alloc
                        ) : _composite_parent_t(e, copy, alloc), _prior(nullptr)
                        {
                        }
                        ...
                        inline _result(
                            ...
                            Source&& source
                        ) : _composite_parent_t(e, static_cast<Source&&>(source)), _prior(nullptr)
                        {
                        }
                    ...
                    public:
                        ...
                        inline typename traits::const_pointer prior() const
                        {
                            return this->_prior;
                        }

                        inline typename traits::pointer prior()
                        {
                            return this->_prior;
                        }
                        ...
                        {
                            typename traits::pointer p = _composite_parent_t::erase_next();
                        ...
                        inline void insert_prior(typename traits::pointer p)
                        {
                            if (this->_prior)
                            {
                                this->_prior->_set_next(p);
                                p->_prior = this->_prior;
                            }
                        ...
                        {
                            typename traits::pointer p = this->_prior;

                            this->_prior = p->_prior;
...
#endif  // ODDS_AND_ENDS__NODE__LINKED__DOUBLY_HPP
