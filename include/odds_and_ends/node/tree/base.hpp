...
#ifndef ODDS_AND_ENDS__NODE__TREE__BASE_HPP
#define ODDS_AND_ENDS__NODE__TREE__BASE_HPP
            ...
            struct type
            {
                ...
                class apply
                {
                    ...
                    protected:
                        ...
                        ) : _composite_parent_t(e), _parent(nullptr)
                        {
                        }
                        ...
                        ) : _composite_parent_t(e, arg_pack), _parent(nullptr)
                        {
                        }
                        ...
                        inline _result(
                            ...
                            Arg const& arg
                        ) : _composite_parent_t(e, arg), _parent(nullptr)
                        {
                        }
                        ...
                        inline _result(
                            ...
                            Copy const& copy
                        ) : _composite_parent_t(e, copy), _parent(nullptr)
                        {
                        }
                        ...
                        inline _result(
                            ...
                            Copy const& copy,
                            Alloc const& alloc
                        ) : _composite_parent_t(e, copy, alloc), _parent(nullptr)
                        {
                        }
                        ...
                        inline _result(
                            ...
                            Source&& source
                        ) : _composite_parent_t(e, static_cast<Source&&>(source)), _parent(nullptr)
                        {
                        }
                    ...
                    public:
                        ...
                        inline typename traits::const_pointer parent() const
                        {
                            return this->_parent;
                        }

                        inline typename traits::pointer parent()
                        {
                            return this->_parent;
                        }

                    protected:
                        inline void parent(typename traits::pointer p)
                        {
                            this->_parent = p;
                        }
...
#endif  // ODDS_AND_ENDS__NODE__TREE__BASE_HPP
