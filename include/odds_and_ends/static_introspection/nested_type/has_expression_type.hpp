...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__HAS_EXPRESSION_TYPE_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__HAS_EXPRESSION_TYPE_HPP
...
namespace _detail {
    ...
    struct has_expression_type :
        ::boost::mpl::eval_if<
            ...
            ::_detail::has_expression_type_void_or_not<T>::type,
            ::odds_and_ends::static_introspection::nested_type
            ::_detail::has_expression_type_non_void<T>,
            ::boost::mpl::false_
        >
    {
    };
...
namespace odds_and_ends { namespace static_introspection { namespace nested_type {
    ...
    template <typename T>
    struct has_expression_type :
        ::odds_and_ends::static_introspection::nested_type::_detail::has_expression_type<
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__HAS_EXPRESSION_TYPE_HPP
