...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__FIRST_TYPE_OF_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__FIRST_TYPE_OF_HPP
...
namespace odds_and_ends { namespace static_introspection { namespace nested_type {
    ...
    template <typename T>
    struct first_type_of :
        ::odds_and_ends::static_introspection::nested_type::_detail::first_type_of<
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__FIRST_TYPE_OF_HPP
