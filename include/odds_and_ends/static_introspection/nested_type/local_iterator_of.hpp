...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__LOCAL_ITERATOR_OF_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__LOCAL_ITERATOR_OF_HPP
...
namespace _detail {
    ...
    {
        typedef typename ::std::remove_const<T>::type::const_local_iterator type;
    };
}  // namespace _detail
}}}  // namespace odds_and_ends::static_introspection::nested_type
...
namespace _detail {
    ...
    template <typename T>
    struct const_local_iterator_of :
        ::boost::mpl::eval_if<
    ...
    struct local_iterator_of :
        ::boost::mpl::eval_if<
            ::std::is_const<T>,
            ::odds_and_ends::static_introspection::nested_type::_detail::const_local_iterator_of<T>,
            ::boost::mpl::eval_if<
                ::boost::type_erasure::is_placeholder<T>,
                ::boost::mpl::identity<void>,
                ::odds_and_ends::static_introspection::nested_type::_detail::local_iterator_of_impl<T>
            >
        >
    {
    };
...
namespace odds_and_ends { namespace static_introspection { namespace nested_type {
    ...
    template <typename T>
    struct local_iterator_of :
        ::odds_and_ends::static_introspection::nested_type::_detail::local_iterator_of<
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__LOCAL_ITERATOR_OF_HPP
