...
namespace _detail {
    ...
    struct is_element_of :
        ::boost::mpl::if_<
            ::std::is_same<
                typename ::odds_and_ends::static_introspection::nested_type::element_of<T2>::type,
...
namespace odds_and_ends { namespace static_introspection { namespace nested_type {
    ...
    struct is_element_of :
        ::boost::mpl::if_<
            ::odds_and_ends::static_introspection::nested_type::has_element<T2>,
            ::odds_and_ends::static_introspection::nested_type::_detail::is_element_of<T1,T2>,
            ::boost::mpl::false_
        >::type
    {
    };
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__IS_ELEMENT_OF_HPP
