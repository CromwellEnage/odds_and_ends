...
namespace _detail {
    ...
    BOOST_MPL_HAS_XXX_TRAIT_NAMED_DEF(has_iterator_category_void_or_not, iterator_category, false)
}  // namespace _detail
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__HAS_ITERATOR_CATEGORY_HPP
