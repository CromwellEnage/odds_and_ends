...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__IS_VALUE_TYPE_OF_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__IS_VALUE_TYPE_OF_HPP
    ...
    struct is_value_type_of_value :
        ::boost::mpl::if_<
            ::std::is_same<
                ...
                ::nested_type::value_type_of<T2>::type,
...
namespace odds_and_ends { namespace static_introspection { namespace nested_type {
    ...
    struct is_value_type_of :
        ::boost::mpl::if_<
            ...
            ::_detail::is_value_type_of_value<T1,T2>,
            ::boost::mpl::false_
        >::type
    {
    };
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__NESTED_TYPE__IS_VALUE_TYPE_OF_HPP
