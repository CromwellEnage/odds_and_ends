...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__CONCEPT__IS_ALLOCATOR_AWARE_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__CONCEPT__IS_ALLOCATOR_AWARE_HPP

#include <odds_and_ends/static_introspection_fwd.hpp>
#include <odds_and_ends/static_introspection/concept/_detail/is_container.hpp>
#include <odds_and_ends/static_introspection/concept/_detail/is_allocator_aware.hpp>
...
namespace odds_and_ends { namespace static_introspection { namespace concept {
    ...
    struct is_allocator_aware :
        ::odds_and_ends::static_introspection::concept::_detail::is_container<
            ...
            ::odds_and_ends::static_introspection::concept
            ::_detail::is_const_allocator_aware,
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__CONCEPT__IS_ALLOCATOR_AWARE_HPP
