...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__CONCEPT__IS_PRE_INCREMENTABLE_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__CONCEPT__IS_PRE_INCREMENTABLE_HPP
...
namespace odds_and_ends { namespace static_introspection { namespace concept { namespace _detail {
    ...
    struct is_pre_incrementable :
        ::boost::mpl::if_<
            ...
            ::_detail::has_pre_increment_operator<T>::type,
            ::odds_and_ends::static_introspection::concept::_detail
            ::is_pre_incrementable_impl<T,ResultPlaceholderExpr>,
            ::boost::mpl::false_
        >::type
    {
    };
...
namespace odds_and_ends { namespace static_introspection { namespace concept {
    ...
    template <typename T, typename ResultPlaceholderExpr>
    struct is_pre_incrementable :
        ::odds_and_ends::static_introspection::concept::_detail::is_pre_incrementable<
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__CONCEPT__IS_PRE_INCREMENTABLE_HPP
