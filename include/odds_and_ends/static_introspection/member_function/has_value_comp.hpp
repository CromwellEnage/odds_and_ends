...
namespace _detail {
    ...
    struct has_value_comp_impl :
        ::boost::mpl::apply1<
            ...
            decltype(::odds_and_ends::static_introspection::declcref<T>().value_comp())
        >
    {
    };
}  // namespace _detail
...
#include <type_traits>
#include <odds_and_ends/static_introspection/nested_type/value_compare_of.hpp>
    ...
    struct has_value_comp_default :
        ::boost::mpl::if_<
            ::std::is_same<
                ...
                ::nested_type::value_compare_of<T>::type,
                decltype(::odds_and_ends::static_introspection::declcref<T>().value_comp())
            >,
            ::boost::mpl::true_,
            ::boost::mpl::false_
...
#include <odds_and_ends/static_introspection/nested_type/has_value_compare.hpp>
...
namespace _detail {
    ...
    template <typename T>
    struct has_value_comp_impl<T,::odds_and_ends::use_default_policy> :
        ::boost::mpl::if_<
            ::odds_and_ends::static_introspection::nested_type::has_value_compare<T>,
            ::odds_and_ends::static_introspection::member_function
            ::_detail::has_value_comp_default<T>,
            ::boost::mpl::false_
        >::type
    {
    };
...
namespace _detail {
    ...
    template <typename T>
    class has_value_comp_expr
    {
        template <typename B>
        static ::boost::type_traits::yes_type
            _check(
                typename ::std::add_pointer<
                    decltype(::odds_and_ends::static_introspection::declcref<B>().value_comp())
                >::type
            );
    ...
    public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ::odds_and_ends::static_introspection::member_function
                ::_detail::has_value_comp_expr<T>::template _check<T>(nullptr)
    ...
    struct has_value_comp :
        ::boost::mpl::if_<
            typename ::odds_and_ends::static_introspection
            ::member_function::_detail::has_value_comp_expr<T>::type,
            /*::odds_and_ends::static_introspection::member_function
            ::_detail::has_value_comp_impl<T,ResultPlaceholderExpr>*/::boost::mpl::true_,
            ::boost::mpl::false_
        >::type
    {
    };
...
namespace odds_and_ends { namespace static_introspection { namespace member_function {
    ...
    struct has_value_comp :
        ::boost::mpl::if_<
            ...
            ::odds_and_ends::static_introspection::member_function
            ::_detail::has_value_comp<T,ResultPlaceholderExpr>
        >::type
    {
    };
}}}  // namespace odds_and_ends::static_introspection::member_function

#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_VALUE_COMP_HPP
