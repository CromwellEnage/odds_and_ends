...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_INDEX_BASES_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_INDEX_BASES_HPP
...
namespace _detail {
    ...
    struct has_index_bases_impl :
        ::boost::mpl::apply1<
            ...
            decltype(::odds_and_ends::static_introspection::declcref<T>().index_bases())
        >::type
    {
    };
}  // namespace _detail
...
namespace _detail {
    ...
    template <typename T>
    struct has_index_bases_impl<T,::odds_and_ends::use_default_policy> :
        ::boost::mpl::if_<
        ...
        static ::boost::type_traits::yes_type
            _check(
                typename ::std::add_pointer<
                    decltype(::odds_and_ends::static_introspection::declcref<B>().index_bases())
                >::type
            );
    ...
    public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ...
                ::_detail::has_index_bases<T>::_check<T>(nullptr)
...
namespace odds_and_ends { namespace static_introspection { namespace member_function {
    ...
    struct has_index_bases :
        ::boost::mpl::if_<
            ...
            ::member_function::_detail::has_index_bases<T>::type,
            ::odds_and_ends::static_introspection::member_function
            ::_detail::has_index_bases_impl<T,ResultPlaceholderExpr>,
            ::boost::mpl::false_
        >::type
    {
    };
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_INDEX_BASES_HPP
