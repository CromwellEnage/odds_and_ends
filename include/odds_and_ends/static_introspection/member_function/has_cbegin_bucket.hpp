...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_CBEGIN_BUCKET_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_CBEGIN_BUCKET_HPP
...
namespace _detail {
    ...
    struct has_cbegin_bucket_impl :
        ::boost::mpl::apply1<
            ...
            decltype(
                ::odds_and_ends::static_introspection::declcref<T>().cbegin(
                    ::std::declval<Param>()
                )
            )
        >::type
...
namespace _detail {
    ...
    struct has_cbegin_bucket_impl<T,Param,::odds_and_ends::use_default_policy> :
        ...
        static ::boost::type_traits::yes_type
            _check(
                typename ::std::add_pointer<
                    decltype(
                        ::odds_and_ends::static_introspection::declcref<B>().cbegin(
                            ::std::declval<P>()
                        )
                    )
                >::type
    ...
    public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ...
                ::has_cbegin_bucket_expr<T,Param>::template _check<T,Param>(nullptr)
...
namespace _detail {
    ...
    struct has_cbegin_bucket :
        ::boost::mpl::if_<
            ...
            ::_detail::has_cbegin_bucket_expr<T,Param>::type,
            ::odds_and_ends::static_introspection::member_function::_detail
            ::has_cbegin_bucket_impl<T,Param,ResultPlaceholderExpr>,
            ::boost::mpl::false_
        >::type
    {
    };
...
namespace _detail {
    ...
    struct has_cbegin_bucket_default :
        ::boost::mpl::if_<
            ::odds_and_ends::static_introspection::member_function::_detail::has_cbegin_bucket<
                T,
...
namespace _detail {
    ...
    template <typename T, typename ResultPlaceholderExpr>
    struct has_cbegin_bucket<T,::odds_and_ends::use_default_policy,ResultPlaceholderExpr> :
        ::boost::mpl::if_<
            ::odds_and_ends::static_introspection::nested_type::has_size_type<T>,
            ::odds_and_ends::static_introspection::member_function
            ::_detail::has_cbegin_bucket_default<T,ResultPlaceholderExpr>,
            ::boost::mpl::false_
        >::type
    {
    };
...
namespace odds_and_ends { namespace static_introspection { namespace member_function {
    ...
    struct has_cbegin_bucket :
        ::odds_and_ends::static_introspection::member_function
        ::_detail::has_cbegin_bucket<T,Param,ResultPlaceholderExpr>
    {
    };
}}}  // namespace odds_and_ends::static_introspection::member_function

#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_CBEGIN_BUCKET_HPP
