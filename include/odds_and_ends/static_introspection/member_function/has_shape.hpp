...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_SHAPE_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_SHAPE_HPP
...
namespace _detail {
    ...
    struct has_shape_impl :
        ::boost::mpl::apply1<
            ...
            decltype(::odds_and_ends::static_introspection::declcref<T>().shape())
        >::type
    {
    };
}  // namespace _detail
...
namespace _detail {
    ...
    template <typename T>
    struct has_shape_impl<T,::odds_and_ends::use_default_policy> :
        ::boost::mpl::if_<
            ::odds_and_ends::static_introspection::nested_type::has_size_type<T>,
            ::odds_and_ends::static_introspection
            ::member_function::_detail::has_shape_default<T>,
            ::boost::mpl::false_
        >::type
    {
    };
        ...
        static ::boost::type_traits::yes_type
            _check(
                typename ::std::add_pointer<
                    decltype(::odds_and_ends::static_introspection::declcref<B>().shape())
                >::type
            );
    ...
    public:
        typedef ::boost::mpl::bool_<
            sizeof(
                ...
                ::_detail::has_shape<T>::_check<T>(nullptr)
...
namespace odds_and_ends { namespace static_introspection { namespace member_function {
    ...
    struct has_shape :
        ::boost::mpl::if_<
            ...
            ::member_function::_detail::has_shape<T>::type,
            ::odds_and_ends::static_introspection::member_function
            ::_detail::has_shape_impl<T,ResultPlaceholderExpr>,
            ::boost::mpl::false_
        >::type
    {
    };
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_SHAPE_HPP
