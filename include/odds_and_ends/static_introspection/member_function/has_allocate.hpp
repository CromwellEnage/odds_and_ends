...
namespace odds_and_ends { namespace static_introspection { namespace _detail {
    ...
    public:
        typedef typename ::boost::mpl::eval_if_c<
            sizeof(
                ...
                ::has_allocate<T,U,ResultPlaceholderExpr>::template _check<T,U>(nullptr)
            ) == sizeof(::boost::type_traits::yes_type),
            ::odds_and_ends::static_introspection::_detail
            ::has_allocate_impl<T,U,ResultPlaceholderExpr>,
            ::boost::mpl::false_
        >::type type;
    };

    template <typename T, typename ResultPlaceholderExpr>
    class has_allocate<T,::odds_and_ends::use_default_policy,ResultPlaceholderExpr>
    {
        template <typename B>
        static ::boost::type_traits::yes_type
            _check(
    ...
    public:
        typedef typename ::boost::mpl::eval_if_c<
            sizeof(
                ::odds_and_ends::static_introspection::_detail
                ::has_allocate<T,::odds_and_ends::use_default_policy,ResultPlaceholderExpr>
                ::template _check<T>(nullptr)
            ) == sizeof(::boost::type_traits::yes_type),
            ::odds_and_ends::static_introspection::_detail
            ::has_allocate_impl<T,::odds_and_ends::use_default_policy,ResultPlaceholderExpr>,
            ::boost::mpl::false_
        >::type type;
    };
}}}  // namespace odds_and_ends::static_introspection::_detail
