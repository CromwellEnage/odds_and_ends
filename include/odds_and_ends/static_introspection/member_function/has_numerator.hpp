...
#ifndef ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_NUMERATOR_HPP
#define ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_NUMERATOR_HPP
...
namespace _detail {
    ...
    struct has_numerator_impl :
        ::boost::mpl::apply1<
            ...
            decltype((::odds_and_ends::static_introspection::declcref<T>().numerator)())
        >::type
    {
    };
}  // namespace _detail
        ...
        static ::boost::type_traits::yes_type
            _check(
                typename ::std::add_pointer<
                    decltype((::odds_and_ends::static_introspection::declcref<B>().numerator)())
                >::type
            );
...
namespace odds_and_ends { namespace static_introspection { namespace member_function {
    ...
    struct has_numerator :
        ::boost::mpl::if_<
            ...
            ::member_function::_detail::has_numerator<T>::type,
            ::odds_and_ends::static_introspection::member_function
...
#endif  // ODDS_AND_ENDS__STATIC_INTROSPECTION__MEMBER_FUNCTION__HAS_NUMERATOR_HPP
