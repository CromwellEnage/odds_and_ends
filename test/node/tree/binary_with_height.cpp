...
int main(int argc, char** argv)
{
    ...
    BOOST_TEST(9 == *n09);
    BOOST_TEST(0 == n09.height());
    BOOST_TEST(17 == *n17);
    BOOST_TEST(0 == n17.height());
    BOOST_TEST(23 == *n23);
    BOOST_TEST(0 == n23.height());
    BOOST_TEST(50 == *n50);
    BOOST_TEST(0 == n50.height());
    BOOST_TEST(76 == *n76);
    BOOST_TEST(0 == n76.height());
    n50.set_left(n17);
    BOOST_TEST(1 == n50.height());
    n50.set_right(n76);
    BOOST_TEST(1 == n50.height());
    n17.set_left(n09);
    BOOST_TEST(1 == n17.height());
    BOOST_TEST(2 == n50.height());
    n17.set_right(n23);
    BOOST_TEST(1 == n17.height());
    BOOST_TEST(2 == n50.height());
