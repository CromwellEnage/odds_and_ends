...
void test_01()
{
    ...
    ::odds_and_ends::node::depth_first_tree_iterator<binary_tree_node> dft_fwd_itr(n13);
    ...
    BOOST_TEST(n27.begin() == n27.end());
    BOOST_TEST(n27.rbegin() == n27.rend());
    dft_fwd_itr = ::odds_and_ends::node::make_depth_first_tree_iterator(n13);
    BOOST_TEST(13 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    ...
    ++dft_fwd_itr;
    BOOST_TEST(!dft_fwd_itr);
    dft_rev_itr = ::odds_and_ends::node::make_depth_first_tree_reverse_iterator(n13);
    BOOST_TEST(13 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
