...
void test_00()
{
    ...
    ::odds_and_ends::node::depth_first_tree_iterator<binary_tree_node> dft_fwd_itr(btn_p50);
    ...
    BOOST_TEST(!btn_p76.left());
    BOOST_TEST(!btn_p76.right());
    dft_fwd_itr = ::odds_and_ends::node::make_depth_first_tree_iterator(btn_p17);
    BOOST_TEST(17 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    ...
    ++dft_fwd_itr;
    BOOST_TEST(!dft_fwd_itr);
    dft_rev_itr = ::odds_and_ends::node::make_depth_first_tree_reverse_iterator(btn_p17);
    BOOST_TEST(17 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    ...
    BOOST_TEST(50 == **btn_p17.parent());
    dft_fwd_itr = ::odds_and_ends::node::make_depth_first_tree_iterator(btn_p50);
    BOOST_TEST(50 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    ...
    ++dft_fwd_itr;
    BOOST_TEST(!dft_fwd_itr);
    dft_rev_itr = ::odds_and_ends::node::make_depth_first_tree_reverse_iterator(btn_p50);
    BOOST_TEST(50 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
...
void test_01()
{
    ...
    ::odds_and_ends::node::depth_first_tree_iterator<binary_tree_node> dft_fwd_itr(btn_p13);

    BOOST_TEST(13 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    ++dft_fwd_itr;
    BOOST_TEST(8 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    ...
    BOOST_TEST(btn_p25.rbegin() + 2 == btn_p25.rend());
    dft_fwd_itr = ::odds_and_ends::node::make_depth_first_tree_iterator(btn_p13);
    BOOST_TEST(13 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    ...
    ++dft_fwd_itr;
    BOOST_TEST(!dft_fwd_itr);
    dft_rev_itr = ::odds_and_ends::node::make_depth_first_tree_reverse_iterator(btn_p13);
    BOOST_TEST(13 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
...
void test_02()
{
    ...
    ::odds_and_ends::node::depth_first_tree_iterator<associative_tree_node> dft_fwd_itr(atn_o00);

    BOOST_TEST(0 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    BOOST_TEST(!dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST(0 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
    ...
    BOOST_TEST(0 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    );
    BOOST_TEST(!dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST(0 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
    ...
    dft_fwd_itr = ::odds_and_ends::node::make_depth_first_tree_iterator(atn_o00);
    BOOST_TEST(0 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    ...
    BOOST_TEST(!dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('i' == dft_fwd_itr->key());
    BOOST_TEST(-3 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    BOOST_TEST(0 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('i' == dft_fwd_itr->key());
    BOOST_TEST(-3 == **dft_fwd_itr);
    BOOST_TEST(
    ...
    ++dft_fwd_itr;
    BOOST_TEST(!dft_fwd_itr);
    dft_rev_itr = ::odds_and_ends::node::make_depth_first_tree_reverse_iterator(atn_o00);
    BOOST_TEST(0 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    ...
    BOOST_TEST(!dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('i' == dft_rev_itr->key());
    BOOST_TEST(-3 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    );
    BOOST_TEST(0 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('i' == dft_rev_itr->key());
    BOOST_TEST(-3 == **dft_rev_itr);
    BOOST_TEST(
    ...
    BOOST_TEST(0 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('n' == dft_fwd_itr->key());
    BOOST_TEST(7 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    BOOST_TEST(-3 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('n' == dft_fwd_itr->key());
    BOOST_TEST(7 == **dft_fwd_itr);
    BOOST_TEST(
    ...
    BOOST_TEST(0 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('n' == dft_rev_itr->key());
    BOOST_TEST(7 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    );
    BOOST_TEST(-3 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('n' == dft_rev_itr->key());
    BOOST_TEST(7 == **dft_rev_itr);
    BOOST_TEST(
    ...
    BOOST_TEST(-3 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('k' == dft_fwd_itr->key());
    BOOST_TEST(9 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    BOOST_TEST(7 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('k' == dft_fwd_itr->key());
    BOOST_TEST(9 == **dft_fwd_itr);
    BOOST_TEST(
    ...
    BOOST_TEST(-3 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('k' == dft_rev_itr->key());
    BOOST_TEST(9 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    );
    BOOST_TEST(7 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('k' == dft_rev_itr->key());
    BOOST_TEST(9 == **dft_rev_itr);
    BOOST_TEST(
    ...
    BOOST_TEST(-3 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('t' == dft_fwd_itr->key());
    BOOST_TEST(12 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    ...
    BOOST_TEST(0 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('t' == dft_rev_itr->key());
    BOOST_TEST(12 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    );
    ...
    BOOST_TEST(0 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('o' == dft_fwd_itr->key());
    BOOST_TEST(8 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    BOOST_TEST(-1 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('o' == dft_fwd_itr->key());
    BOOST_TEST(8 == **dft_fwd_itr);
    BOOST_TEST(
    ...
    BOOST_TEST(0 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('o' == dft_rev_itr->key());
    BOOST_TEST(8 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    );
    BOOST_TEST(-1 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('o' == dft_rev_itr->key());
    BOOST_TEST(8 == **dft_rev_itr);
    BOOST_TEST(
    ...
    BOOST_TEST(0 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('e' == dft_fwd_itr->key());
    BOOST_TEST(-2 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    ...
    BOOST_TEST(-1 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('e' == dft_rev_itr->key());
    BOOST_TEST(-2 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    );
    ...
    BOOST_TEST(-1 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('d' == dft_fwd_itr->key());
    BOOST_TEST(5 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    BOOST_TEST(-2 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('d' == dft_fwd_itr->key());
    BOOST_TEST(5 == **dft_fwd_itr);
    BOOST_TEST(
    ...
    BOOST_TEST(-1 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('d' == dft_rev_itr->key());
    BOOST_TEST(5 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    );
    BOOST_TEST(-2 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('d' == dft_rev_itr->key());
    BOOST_TEST(5 == **dft_rev_itr);
    BOOST_TEST(
    ...
    BOOST_TEST(1 == **dft_fwd_itr->parent());
    ++dft_fwd_itr;
    BOOST_TEST('r' == dft_fwd_itr->key());
    BOOST_TEST(4 == **dft_fwd_itr);
    BOOST_TEST(
        ::odds_and_ends::node::pre_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_fwd_itr)
    );
    ...
    BOOST_TEST(-2 == **dft_rev_itr->parent());
    ++dft_rev_itr;
    BOOST_TEST('r' == dft_rev_itr->key());
    BOOST_TEST(4 == **dft_rev_itr);
    BOOST_TEST(
        ::odds_and_ends::node::post_order_traversal ==
        ::odds_and_ends::node::traversal_state(dft_rev_itr)
    );
